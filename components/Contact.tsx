...
const Contact = () => {
    ...
    const handleSubmit = () => {
        const distinationMail = 'mohammedsofficial127@gmail.com';
    ...
    return (
        <div className='main-prop max-container overflow-hidden padding-container'id='Contact'>
            <div className='section-header my-10 flex-center gap-2'>
                    <motion.p variants={navVariants} initial="hidden" whileInView="show">Contact</motion.p>
            ...
            <div className=' flex justify-center relative py-20 bg-[#0d0d0db3] xs:h-full lg:h-[110vh] overflow-hidden'>
                <div className=' flex justify-around items-center xs:flex-col lg:flex-row xs:w-full md:w-5/6 h-full'>
                    <motion.div 
                        variants={fadeIn("right","spring",0,2)} initial="hidden" whileInView="show"
                        className='relative flex-1 z-10 pb-20' >
                    ...
                    <motion.div  
                    variants={fadeIn("left","spring",0,2)}  initial="hidden" whileInView="show"
                    className='form-container relative  xs:w-[350px] md:w-[500px] ' >
